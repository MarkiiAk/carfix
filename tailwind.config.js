  ...
  theme: {
    extend: {
      colors: {
        ...
        // Reemplaza la paleta gray de Tailwind (tiene tinte azul) por neutral puro
        gray: {
          50:  '#fafafa',
          100: '#f5f5f5',
          200: '#e5e5e5',
        ...
        // SAG Brand — usa CSS vars para permitir theming (demo = rojo)
        sag: {
          50:  'rgb(var(--sag-50)  / <alpha-value>)',
          100: 'rgb(var(--sag-100) / <alpha-value>)',
          200: 'rgb(var(--sag-200) / <alpha-value>)',
          300: 'rgb(var(--sag-300) / <alpha-value>)',
          400: 'rgb(var(--sag-400) / <alpha-value>)',
          500: 'rgb(var(--sag-500) / <alpha-value>)',
          600: 'rgb(var(--sag-600) / <alpha-value>)',
          700: 'rgb(var(--sag-700) / <alpha-value>)',
          800: 'rgb(var(--sag-800) / <alpha-value>)',
          900: 'rgb(var(--sag-900) / <alpha-value>)',
          950: 'rgb(var(--sag-950) / <alpha-value>)',
        },
      },
      fontFamily: {
